...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()       
            messages.success(request, 'Registeration successfull! We have sent you a verification email to your email address')
...
def resetpassword_validate(request):
    ...
    if user is None and default_token_generator.check_token(user, token):
        ...
        messages.succuess(request, 'Please reset your password')
